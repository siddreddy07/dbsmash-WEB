  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-4 sm:space-y-6">
          ...
          <p>
            * Now Supported <div className='flex bg-gray-200 h-14 rounded-lg py-2 items-center md:gap-4'><img src="https://res.cloudinary.com/deiiozl5e/image/upload/v1751897083/mongodb-removebg-preview_iily21.png" className='w-24 md:w-44 xl:w-52' alt="" /><img src="https://res.cloudinary.com/deiiozl5e/image/upload/v1751897083/supa-removebg-preview_f8he7j.png" className='w-24 md:w-44 xl:w-52' alt="" /><img src="https://res.cloudinary.com/deiiozl5e/image/upload/v1751897083/fb-removebg-preview_d2dc7y.png" className='w-24 md:w-44 xl:w-52' alt="" /></div>
          </p>
